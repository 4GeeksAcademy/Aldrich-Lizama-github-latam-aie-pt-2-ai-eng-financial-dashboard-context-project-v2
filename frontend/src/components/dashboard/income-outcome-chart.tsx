...
export function IncomeOutcomeChart({ data, loading }: IncomeOutcomeChartProps) {
  ...
  return (
    <Card className="border-border/60" role="figure" aria-label="Income vs Outcome chart showing monthly revenue and expenditure evolution">
      <CardHeader className="pb-4">
        ...
        {!hasData ? (
          ...
          <>
            <div className="visually-hidden">
              Chart showing monthly income and outcome data. Data points available for {data.length} months.
            </div>
